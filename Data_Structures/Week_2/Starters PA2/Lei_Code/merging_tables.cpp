...
int main() {
	...
	for (auto &table : tables.sets) // This is an iteration through all the elements in vector table.sets. Each element in vector table.sets is referenced by "table"
	{
		cin >> table.size;
